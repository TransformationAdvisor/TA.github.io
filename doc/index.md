...
- [How to install and run IBM Cloud Transformation Advisor v1.9.3 in an air-gapped IBM Cloud Private 3.1.1 environment](https://www.ibm.com/developerworks/community/blogs/d47ff92c-e968-4584-9fce-d4cce4f095c2/entry/How_to_deploy_IBM_Transformation_Advisor_to_offline_IBM_Cloud_Private_3_1_1_environment?lang=en)
- [How to configure Ingress to use your own CA certificate and key pair for Liberty applications deployed through TA with Ingress enabled](./ssl.md)
- [How to replace TA's Ingress certificate with your own CA certificate](./tassl.md)
